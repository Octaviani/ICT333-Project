package org.vaadin.visjs.networkDiagram.entity;
...
public class EdgeEntity {
    ...
    private EdgeEntity.Style style = Style.line;
    private Dash dash;

    // my additions
    public EdgeEntity(NodeEntity from, NodeEntity to) {
        this.from = from.getId();
        this.to = to.getId();
    }

    public EdgeEntity(NodeEntity from, NodeEntity to, int width) {
        this.from = from.getId();
        this.to = to.getId();
        this.width = width;
    }

    public EdgeEntity(NodeEntity from, NodeEntity to, Color color) {
        this.from = from.getId();
        this.to = to.getId();
        this.color = color;
    }

    public EdgeEntity(NodeEntity from, NodeEntity to, Color color, int width) {
        this.from = from.getId();
        this.to = to.getId();
        this.color = color;
        this.width = width;
    ...
    public EdgeEntity(NodeEntity from, NodeEntity to, EdgeEntity.Style style) {
        this.from = from.getId();
        this.to = to.getId();
        this.style = style;
    ...
    public EdgeEntity(NodeEntity from, NodeEntity to, EdgeEntity.Style style, int width) {
        this.from = from.getId();
        this.to = to.getId();
        this.style = style;
        this.width = width;
    ...
    public EdgeEntity(NodeEntity from, NodeEntity to, EdgeEntity.Style style, Color color) {
        this.from = from.getId();
        this.to = to.getId();
        this.style = style;
        this.color = color;
    ...
    public EdgeEntity(NodeEntity from, NodeEntity to, EdgeEntity.Style style, Color color, int width) {
        this.from = from.getId();
        this.to = to.getId();
        this.style = style;
        this.color = color;
    ...
    @Deprecated
    public EdgeEntity(int from, int to) {
        this.from = Integer.toString(from);
        this.to = Integer.toString(to);
    }

    @Deprecated
    public EdgeEntity(String from, String to) {
        this.from = from;
        this.to = to;
    }

    @Deprecated
    public EdgeEntity(int from, int to, int width) {
        this.from = Integer.toString(from);
        this.to = Integer.toString(to);
        this.width = width;
    }
    ...
    @Deprecated
    public EdgeEntity(String from, String to, int width) {
        this.from = from;
        this.to = to;
        this.width = width;
    }
    ...
    @Deprecated
    public EdgeEntity(int from, int to, Color color) {
        this.from = Integer.toString(from);
        this.to = Integer.toString(to);
        this.color = color;
    }
    ...
    @Deprecated
    public EdgeEntity(String from, String to, Color color) {
        this.from = from;
        this.to = to;
        this.color = color;
    }
    ...
    @Deprecated
    public EdgeEntity(int from, int to, Color color, int width) {
        this.from = Integer.toString(from);
        this.to = Integer.toString(to);
        this.color = color;
        this.width = width;
    ...
    @Deprecated
    public EdgeEntity(String from, String to, Color color, int width) {
        this.from = from;
        this.to = to;
        this.color = color;
        this.width = width;
    ...
    @Deprecated
    public EdgeEntity(int from, int to, EdgeEntity.Style style) {
        this.from = Integer.toString(from);
        this.to = Integer.toString(to);
        this.style = style;
    ...
    @Deprecated
    public EdgeEntity(String from, String to, EdgeEntity.Style style) {
        this.from = from;
        this.to = to;
        this.style = style;
    ...
    @Deprecated
    public EdgeEntity(int from, int to, EdgeEntity.Style style, int width) {
        this.from = Integer.toString(from);
        this.to = Integer.toString(to);
        this.style = style;
        this.width = width;
    ...
    @Deprecated
    public EdgeEntity(String from, String to, EdgeEntity.Style style, int width) {
        this.from = from;
        this.to = to;
        this.style = style;
        this.width = width;
    ...
    @Deprecated
    public EdgeEntity(int from, int to, EdgeEntity.Style style, Color color) {
        this.from = Integer.toString(from);
        this.to = Integer.toString(to);
        this.style = style;
        this.color = color;
    ...
    @Deprecated
    public EdgeEntity(String from, String to, EdgeEntity.Style style, Color color) {
        this.from = from;
        this.to = to;
        this.style = style;
        this.color = color;
    ...
    @Deprecated
    public EdgeEntity(int from, int to, EdgeEntity.Style style, Color color, int width) {
        this.from = Integer.toString(from);
        this.to = Integer.toString(to);
        this.style = style;
        this.color = color;
    ...
    @Deprecated
    public EdgeEntity(String from, String to, EdgeEntity.Style style, Color color, int width) {
        this.from = from;
        this.to = to;
        this.style = style;
        this.color = color;
