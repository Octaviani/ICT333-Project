...
public class NodeEntity {
    ...
    private transient List<EdgeEntity> edgeList = new ArrayList<>();
    ;
    private transient Map<String, EdgeEntity> edgeMap = new HashMap<>();
    ;
    
    private static AtomicLong counter = new AtomicLong(0);

    // my additions
    public NodeEntity(String label) {
        this.id = Long.toString(counter.getAndIncrement());
        this.label = label;
    }

    public NodeEntity(String label, String image) {
        this.id = Long.toString(counter.getAndIncrement());
        this.label = label;
        this.image = image;
    ...
    public NodeEntity(String label, NodeEntity.Shape shape, String group) {
        this.id = Long.toString(counter.getAndIncrement());
        this.label = label;
        this.shape = shape;
        this.group = group;
    ...
    public NodeEntity(String label, NodeEntity.Shape shape, String group, String image) {
        this.id = Long.toString(counter.getAndIncrement());
        this.label = label;
        this.shape = shape;
        this.group = group;
    ...
    @Deprecated
    public NodeEntity(int id, String label) {
        this.id = Integer.toString(id);
        this.label = label;
    }

    @Deprecated
    public NodeEntity(int id, String label, String image) {
        this.id = Integer.toString(id);
        this.label = label;
        this.image = image;
        this.shape = Shape.image;
    ...
    @Deprecated
    public NodeEntity(String id, String label, String image) {
        this.id = id;
        this.label = label;
        this.image = image;
        this.shape = Shape.image;
    ...
    @Deprecated
    public NodeEntity(int id, String label, NodeEntity.Shape shape, String group) {
        this.id = Integer.toString(id);;
        this.label = label;
        this.shape = shape;
        this.group = group;
    ...
    @Deprecated
    public NodeEntity(String id, String label, NodeEntity.Shape shape, String group) {
        this.id = id;
        this.label = label;
        this.shape = shape;
        this.group = group;
    ...
    @Deprecated
    public NodeEntity(int id, String label, NodeEntity.Shape shape, String group, String image) {
        this.id = Integer.toString(id);;
        this.label = label;
        this.shape = shape;
        this.group = group;
    ...
    @Deprecated
    public NodeEntity(String id, String label, NodeEntity.Shape shape, String group, String image) {
        this.id = id;
        this.label = label;
        this.shape = shape;
        this.group = group;
    ...
    public List<EdgeEntity> getConnectedEdges() {
        return edgeList;
    }

    public void setConnectedEdges(List<EdgeEntity> edgeList) {
        this.edgeList = edgeList;
    }

    public void addEdgeToList(EdgeEntity edge) {
        edgeList.add(edge);
    }

    public void removeEdgeFromList(EdgeEntity edge) {
        edgeList.remove(edge);
    }

    public Map<String, EdgeEntity> getEdgeMap() {
        return edgeMap;
    }

    public void setEdgeMap(Map<String, EdgeEntity> edgeMap) {
    ...
    public static abstract class NodeSelectListener extends NodeListener {
        ...
        public NodeSelectListener(NodeEntity node) {
            super(node);
        }
    ...
    public static abstract class NodeClickListener extends NodeListener {
        ...
        public NodeClickListener(NodeEntity node) {
            super(node);
        }
    ...
    public static abstract class NodeDoubleClickListener extends NodeListener {
        ...
        public NodeDoubleClickListener(NodeEntity node) {
            super(node);
        }
    ...
    public static abstract class NodeHoverListener extends NodeListener {
        ...
        public NodeHoverListener(NodeEntity node) {
            super(node);
        }
    ...
    public static abstract class NodeBlurListener extends NodeListener {
        ...
        public NodeBlurListener(NodeEntity node) {
            super(node);
        }
    ...
    public static abstract class NodeDragStartListener extends NodeListener {
        ...
        public NodeDragStartListener(NodeEntity node) {
            super(node);
        }
    ...
    public static abstract class NodeDragEndListener extends NodeListener {
        ...
        public NodeDragEndListener(NodeEntity node) {
            super(node);
        }
