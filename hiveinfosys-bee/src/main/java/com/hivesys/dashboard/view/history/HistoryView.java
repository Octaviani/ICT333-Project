package com.hivesys.dashboard.view.history;
...
import com.hivesys.dashboard.view.dashboard.DashboardEdit;
import com.hivesys.dashboard.view.dashboard.DashboardView;
import com.hivesys.dashboard.view.dashboard.DashboardEdit.DashboardEditListener;
...
public final class HistoryView extends Panel implements View,
	...
	private Component buildEditButton() {
		...
		result.addClickListener(new ClickListener() {
			...
			public void buttonClick(final ClickEvent event) {
				getUI().addWindow(
						new DashboardEdit(HistoryView.this, titleLabel
								.getValue()));
			}
		});
		return result;
